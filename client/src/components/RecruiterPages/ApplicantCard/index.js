  ...
  return (
    <div className={`applicant-user-card applicant-${status.toLowerCase()}`}>
      <div className="applicant-user-info">
        <p className="applicant-info-item">Name: {username || "N/A"}</p>
        <p className="applicant-info-item">Email: {email || "N/A"}</p>
        <p className="applicant-info-item">Phone: {phoneNumber || "N/A"}</p>
        <p className="applicant-info-item">Skills: {skills || "N/A"}</p>
        <p className="applicant-info-item">Education: {educationDetails || "N/A"}</p>
      </div>
