  ...
  return (
    <div className="recruiter-home-page">
      ...
      <div className="recruiter-home-page-container">
        <section>
          <h1 className="green-heading">{recruiterName ? `Welcome, ${recruiterName}!` : "Welcome to  Connect My Career Recruiter Portal"}</h1>
          <p>
            At Connect My Career, we understand the importance of finding the right
        ...
        <section>
          <h2 className="green-heading">Why Choose  Connect My Career?</h2>
          <p>
        ...
        <section>
          ...
          <p>
            Join  Connect My Career and revolutionize your hiring journey. Whether
