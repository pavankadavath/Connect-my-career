    ...
    <div className="jobseeker-home-page">
      ...
      <div className="jobseeker-home-page-container">
        ...
        <section>
          ...
          <h1 className="blue-heading">Note :</h1>
            <p>Before you start applying for jobs, make sure your profile is complete.
            {/* Fixing Link usage */}
            <Link to="/user/updateUserProfile" className="blue-heading">
              Edit profile
            </Link>
            </p>
          </div>
          <p className="ignore-message">Ignore if completed</p>
        </section>
